      ...
      <div className="row text-dark mx-1 p-3 rounded-3 bg-light">
        <div className="col-md-7 col-12 h-auto">
              ...
              <Link className="link" to={"/user-profile"}>
                <div className="user w-100 d-flex align-items-center">
                  <img
                    ...
                    alt=""
                  />
                  <span className="name mx-2 fs-5">Gowtham K</span>
                </div>
              </Link>
              <h4 className="mt-3">Event Name Here</h4>
          ...
          <div className="eventDesc content">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit.jgyjt
            Impedit recusandae quae animi. Dolorum, perferendis similique!
            Itaque esse vel, nsectetur adipisicing elit. Impedit recusandae quae
            animi. Dolorum, perferendis similique! Itaque esse vel,
            <div className="fs-6 my-2">
              <b>Address</b> : 54 C/1 opr plot panruti main road vadalur
            </div>
          </div>
          ...
          <div className="extra d-flex gap-md-4 gap-1 flex-wrap my-3">
            <div className="transport bg-info small-text p-2 rounded">
              {/* <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
              ...
              Travel Amount : <b>No</b>
            </div>
            <div className="vegetables-cutting bg-info small-text p-2 rounded">
              {/* <svg
                width="30px"
                height="30px"
              ...
              Vegetables Cutting : <b>No</b>
            </div>
            <div className="workingHrs bg-info small-text p-2 rounded">
              {/* <svg
                width="26px"
                height="26px"
              ...
              Total Working Hours : <b>5hrs</b>
            </div>
            <div className="experence bg-info small-text p-2 rounded">
              Experience : <b>Required</b>
            </div>
          </div>
        </div>
        <div className="col-md-5 col-12 h-auto">
          <div className="single-page-contact">
            <h4>Contact</h4>
            <p className="m-0" >Phone: 7010399378</p>
            <p className="m-0 mb-2 pb-5" >Email: gowthamkvdl@gmail.com</p>
          </div>
          <div className="spm">
            <SinglePointerMap latitude={13.0827} longitude={80.2707} />
          </div>
